...
/*	Per creare un quadrato dobbiamo generare due triangoli.
	Facendo così però avremmo dei vertici ripetuti, come scritto qui sotto (vertici scritti con i valori x, y, z, r, g, b, a):
...
void INIT_VAO(void)
{
	...
	// Configuro le coordinate posizionali e le faccio saltare di 7 in 7 (ogni vertice è x, y, z, r, g, b, z)
	glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 7 * sizeof(float), (void*)0);
	glEnableVertexAttribArray(0);	// Abilita l'attributo delle coordinate posizionali

	// Configuro i colori con uno stride di 7 e li faccio partire dal valore in posizione 3 (perché 0, 1 e 2 sono per x, y e z)
