...
void INIT_VAO(void)
{
	...
	polygonVertices.push_back(vec3(0.5f, -1.0f, 0.0f));
	polygonVertices.push_back(vec3(0.5f, 0.2f, 0.0f));
	polygonVertices.push_back(vec3(0.1f, 0.2f, 0.0f));
	polygonVertices.push_back(vec3(0.1f, 1.0f, 0.0f));
	polygonVertices.push_back(vec3(-0.1f, 1.0f, 0.0f));
	polygonVertices.push_back(vec3(-0.1f, 0.2f, 0.0f));
	polygonVertices.push_back(vec3(-0.5f, 0.2f, 0.0f));
	polygonVertices.push_back(vec3(-0.5f, -1.0f, 0.0f));
...
void drawScene(void)
{
	...
	*player.getModel() = scale(*player.getModel(), vec3(200.0f, 200.0f, 1.0f));
